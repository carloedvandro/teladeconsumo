      ...
      <main className="mx-auto max-w-[1400px] px-4 pt-6 pb-16 md:px-6 md:pt-8">
        ...
        <section className="relative mt-6 overflow-hidden rounded-md">
          ...
          <button
            ...
            className="relative mx-2 mt-4 flex w-[calc(100%-1rem)] items-center justify-between rounded-md bg-white px-6 py-5 shadow-sm transition hover:shadow-md md:absolute md:bottom-24 md:right-8 md:mx-0 md:mt-0 md:w-[520px]"
          >
