    ...
    <div className="min-h-screen bg-[#f3f3f3]">
      ...
      <main className="mx-auto max-w-[1400px] px-2 pt-6 pb-16 md:px-6 md:pt-8">
        ...
        <section className="relative mt-6 overflow-hidden rounded-md">
          ...
          <div
            className="relative -mt-24 overflow-hidden rounded-md p-3 pb-10 md:absolute md:right-8 md:top-8 md:mx-0 md:mt-0 md:w-[600px] md:translate-y-0 md:px-8 md:py-5 md:pb-8"
            style={{
