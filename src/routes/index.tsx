    ...
    <div className="min-h-screen bg-[#f3f3f3]">
      ...
      <main className="mx-auto max-w-[1400px] px-4 pt-6 pb-16 md:px-6 md:pt-8">
        ...
        <section className="relative mt-6 overflow-hidden rounded-md">
          ...
          <div
            className="relative -mt-24 overflow-hidden rounded-md p-5 pb-10 md:absolute md:left-8 md:top-8 md:mx-0 md:mt-0 md:w-[520px] md:p-5 md:pb-8"
            style={{
          ...
          <button
            ...
            className="relative mt-4 flex w-full items-center justify-between rounded-md bg-white px-6 py-5 shadow-sm transition hover:shadow-md md:absolute md:left-8 md:bottom-8 md:mt-0 md:w-[520px]"
          >
